...
#modulesmempools 
列出所有已创建的内存池及其状态。 
#mempoolsmempool create 
创建一个新的内存池 eg: mempool create small_objects SMALL 1024
#module load/unload 
动态加载或卸载一个功能模块 eg :module load memory_gc.bin
#mount 
挂载文件系统（需先加载对应模块）eg:mount /dev/hda1 /mnt NTFS
```
